...
public:
    ...
    bool get_is_pingpong_task_finished() {
        return m_pingpong_task_finished;
    }

    bool get_is_pingpong_task_started() {
        return NULL != m_pingpong_task.get();
    }

    bool get_is_watch_dog_finish_work() {
        return m_is_watch_dog_finish_work;
    }
